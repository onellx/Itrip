...
public class SendEmailUtil {
    ...
    public static final String FROM ="18279265280@163.com";//发件人的email
    public static final String PWD ="LUOluchen0916";//发件人授权密码
    /**
     * 获取Session
     * @return
     */
...
//Send the message
    ...
    public static void main(String[] args) {
        send("激活信息","18279265280@163.com","http://**********/ftcms");
    }
